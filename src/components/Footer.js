      ...
      <div className='container-xxl'>
        <div className='row align-items-center'>
          ...
          <div className='footer-top-data d-flex gap-30 align-items-center'>
            <span><i className="fa-solid fa-location-arrow fa-2x text-white"></i></span>
      ...
      <div className='row'>
        <div className='col-4'>
          ...
          <div>
           ...
           <a href='tel:91 8264954234' className='mt-3 d-block mb-1 text-white'> +91 8792679047</a>
           <a href='mailto:smitharb23@gmail.com' className='mt-2 d-block mb-0 text-white'>smitharb23@gmail.com</a>
